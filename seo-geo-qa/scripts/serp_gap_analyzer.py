...
def jina_fetch(url: str) -> str:
    ...
    Uses browser rendering for reliable content access on JavaScript-heavy pages.
...
def ddg_search(query: str, limit: int) -> list[str]:
    ...
    # Fallback: Jina renders DDG with a real browser for reliable content access.
...
def parse_doc(url: str) -> CompetitorDoc | None:
    # Primary: Jina Reader — renders with a real browser for reliable content access on JS-heavy pages
    md = jina_fetch(url)
